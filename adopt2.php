                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                            ...
                                            <select name="gender" class="form-control">
												...
												<option value="EzCash">Female</option>
                                            </select>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                    <label>Any further details about the animal (eg. any disease)</label>
                                    <input name="details" class="form-control" >
                            </div>
                            <div class="form-group">
                                <label>Add Picture of the animal</label>
                                <input type="file" id="myfile" name="image" multiple><br>
                            </div>
                       </div>  
                    </div>
                </div>
                    ...
                    <div class="well">
						...
						<?php
							...
							else
							{
								...
								$newUser="INSERT INTO adopt (fname,lname,email,address,pnum,type,gender,breed,details) VALUES ('$_POST[fname]','$_POST[lname]','$_POST[email]','$_POST[address]','$_POST[phone]','$_POST[type]','$_POST[gender]','$_POST[breed]','$_POST[details]')";
