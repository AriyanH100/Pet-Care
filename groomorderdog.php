                    ...
                    <div class="well">
						...
						<?php
							...
							else
							{
								...
								$newUser="INSERT INTO groomorderdetails (fname,lname,email,address,pnum,pmethod,pid,pet,approval) VALUES ('$_POST[fname]','$_POST[lname]','$_POST[email]','$_POST[address]','$_POST[phone]','$_POST[pmeth]','$ID','dog','No')";
								if (mysqli_query($con,$newUser))
								{
									echo "<script type='text/javascript'> alert('Your booking has been sent')</script>";
								}
								else
								{
									echo "<script type='text/javascript'> alert('Error booking the service')</script>";
								}
