        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a  href="bird.php"><i class="fa fa-home"></i>Vet Details</a>
                    </li>
					</ul>
            </div>
        </nav>
			 ...
			 <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-header">
                            Appointment Details <small></small>
                        </h1>
                    </div>
                </div>   
            <div class="row">
                    ...
                    <div class="well">
						...
						<?php
							...
							else
							{
								...
								$newUser="INSERT INTO vetbook (name,email,addr,sdate,phone,vet) VALUES ('$_POST[fname]','$_POST[email]','$_POST[addr]','$_POST[rdate]','$_POST[phone]','$name')";
