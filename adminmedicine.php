			 ...
			 <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-header">
                           Approve Medicine Order<small> </small>
                        </h1>
                    </div>
                </div> 
            <div class="row">
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    if (isset($_GET['approve'])) 
                                    {
                                        ...
                                        if ($con->query("update medorderdetails set approval='Yes' where mid = '$_GET[approve]'"))
                                        {
                                    ...
                                    <?php
										include ('db.php');
										$sql="select * from medorderdetails,ordermed where medorderdetails.pid=ordermed.id";
										...
										while($row = mysqli_fetch_array($re))
										{
                                            ...
                                            else
                                            {
                                                ...
                                                <td>".$row['pet']."</td>
                                                <td>".$row['name']."</td>
                                                <td><a href=adminmedicine.php?approve=".$row['mid']." <button class='btn btn-primary'> <i class='fa fa-edit' ></i>Approve</button></td>
                                                </tr>";  
                                            }
